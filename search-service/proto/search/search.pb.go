...
func (x *MsgSearch) GetTest() string {
	if x != nil {
		return x.Test
	}
	return ""
...
var file_proto_search_search_proto_rawDesc = []byte{
	...
	0x1f, 0x0a, 0x09, 0x4d, 0x73, 0x67, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x12, 0x0a, 0x04,
	0x74, 0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x65, 0x73, 0x74,
	0x32, 0x46, 0x0a, 0x0d, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x35, 0x0a, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x18, 0x2e, 0x73, 0x65,
	0x61, 0x72, 0x63, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4d, 0x73, 0x67, 0x53,
	0x65, 0x61, 0x72, 0x63, 0x68, 0x1a, 0x11, 0x2e, 0x73, 0x64, 0x6b, 0x2e, 0x42, 0x61, 0x73, 0x65,
...
var file_proto_search_search_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_search_search_proto_goTypes = []interface{}{
	(*MsgSearch)(nil),        // 0: searchService.MsgSearch
	(*sdk.BaseResponse)(nil), // 1: sdk.BaseResponse
}
var file_proto_search_search_proto_depIdxs = []int32{
	0, // 0: searchService.searchService.search:input_type -> searchService.MsgSearch
	1, // 1: searchService.searchService.search:output_type -> sdk.BaseResponse
